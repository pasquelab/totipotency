...
.loom files can be downloaded here: [loom](https://filesender.belnet.be/?s=download&token=592df57b-ec33-41d0-bf0b-c5c82b081fbb)
and browsed interactively using [SCope platform](scope.aertslab.org). SCope was developed and is maintained by [Aerts lab.](https://www.aertslab.org/)
